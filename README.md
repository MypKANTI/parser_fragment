...
**max_concurrent_connections** - это максимальное количество подключений нужно для асинхронности хотя используется асинхронный код но вывод у меня синхронный
